  ...
  <div class="modal fade" id="aprobar_orden2" tabindex="-1">
        ...
        <div class="modal-body">
          <div class="card">
            <div class="card-body"> 
              ...
              <div class="my-3 mt-2 mt-md-0 position-relative">
                <label for="" class="my-3 fw-bold">2 ° Aprobacion</label>
              ...
              <div class="my-5 position-relative">
                ...
                <div class="row col-12 col-md-5 pt-4 mx-auto">
                  <button name="btn_aprobacion2" class="p-3 fw-bold btn btn-primary" type="submit">GUARDAR</button>
                </div>
