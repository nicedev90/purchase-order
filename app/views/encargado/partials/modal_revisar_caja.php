  ...
  <div class="modal fade" id="aprobar_caja" tabindex="-1">
          ...
          <div class="card">
            <div class="card-body"> 
              <form action="" class="col-md-12 needs-validation" novalidate method="POST" >
                <input type="hidden" name="num_caja" value="<?php echo $data['caja'][0]->num_caja ?>">
                <input type="hidden" name="usuario" value="<?php echo $data['caja'][0]->usuario ?>">
              ...
              <div class="my-3 mt-2 mt-md-0 position-relative">
                <label for="" class="my-3 fw-bold"> Aprobar Caja Chica</label>
              ...
              <div class="my-5 position-relative">
                ...
                <div class="row col-12 col-md-5 pt-4 mx-auto">
                  <button name="btn_revisar" class="p-3 fw-bold btn btn-primary" type="submit">GUARDAR CAMBIOS</button>
                </div>
